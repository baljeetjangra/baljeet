  ...
  return (
    <li className="mb-20">
      ...
      <a
        ...
        target="_blank"
        className="before:z-2 before:content-[' '] group relative mx-auto block h-[480px] w-2/3 overflow-hidden bg-query-overflow bg-cover shadow-xl transition-all duration-300 ease-in before:absolute before:left-0 before:top-0 before:block before:h-full before:w-full before:bg-black before:opacity-60"
      >
        {/* Hover Mask */}
